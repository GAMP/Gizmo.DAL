...
internal static class SqlServer
{
    ...
    {
        using (var trx = cx.Database.BeginTransaction(IsolationLevel.Serializable))
        {
    ...
    public static async Task CleanupUsers(this DefaultDbContext cx, CancellationToken ct)
    {
        using (var trx = cx.Database.BeginTransaction(IsolationLevel.Serializable))
        {
            ...
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[AssetTransaction] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[AppStat] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[AppRating] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[AssistanceRequest] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ReservationUser] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Reservation] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UsageTime] WHERE UsageId IN (SELECT UsageId FROM [dbo].[Usage] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UsageTimeFixed] WHERE UsageId IN (SELECT UsageId FROM [dbo].[Usage] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UsageRate] WHERE UsageId IN (SELECT UsageId FROM [dbo].[Usage] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UsageUserSession] WHERE UsageId IN (SELECT UsageId FROM [dbo].[Usage] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UsageSession] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Usage] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UserSessionChange] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UserSessionChange] WHERE CreatedById IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UserSession] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[RefundInvoicePayment] WHERE InvoicePaymentId IN (SELECT InvoicePaymentId FROM [dbo].[InvoicePayment] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[RefundDepositPayment] WHERE DepositPaymentId IN (SELECT DepositPaymentId FROM [dbo].[DepositPayment] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Refund] WHERE PaymentId IN (SELECT PaymentId FROM [dbo].[Payment] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[RefundDepositPayment] WHERE RefundId IN (SELECT RefundId FROM [dbo].[Refund] WHERE DepositTransactionId IN (SELECT DepositTransactionId FROM [dbo].[DepositTransaction] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL)))", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Refund] WHERE DepositTransactionId IN (SELECT DepositTransactionId FROM [dbo].[DepositTransaction] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoicePayment] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[PaymentIntentDeposit] WHERE PaymentIntentId IN (SELECT PaymentIntentId FROM [dbo].[PaymentIntent] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[PaymentIntent] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[DepositPayment] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Payment] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"UPDATE InvoiceLineExtended SET BundleLineId=NULL WHERE InvoiceLineId IN (SELECT InvoiceLineId FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoiceLineProduct] WHERE InvoiceLineId IN (SELECT InvoiceLineId FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoiceLineSession] WHERE InvoiceLineId IN (SELECT InvoiceLineId FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoiceLineTime] WHERE InvoiceLineId IN (SELECT InvoiceLineId FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoiceLineTimeFixed] WHERE InvoiceLineId IN (SELECT InvoiceLineId FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoiceLineExtended] WHERE InvoiceLineId IN (SELECT InvoiceLineId FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[InvoiceLine] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Invoice] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"UPDATE ProductOLExtended SET BundleLineId=NULL WHERE ProductOLId IN (SELECT ProductOLId FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOLTimeFixed] WHERE ProductOLId IN (SELECT ProductOLId FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOLTime] WHERE ProductOLId IN (SELECT ProductOLId FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOLSession] WHERE ProductOLId IN (SELECT ProductOLId FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOLProduct] WHERE ProductOLId IN (SELECT ProductOLId FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOLExtended] WHERE ProductOLId IN (SELECT ProductOLId FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL));", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOL] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[ProductOrder] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[DepositTransaction] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[PointTransaction] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[HostGroupWaitingLineEntry] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);

            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UserCreditLimit] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UserAttribute] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            ...
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[UserNote] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Verification] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [dbo].[Token] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            ...
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [UserMember] WHERE UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
            await cx.Database.ExecuteSqlAsync($"DELETE FROM [User] WHERE IsDeleted=1 AND UserId IN (SELECT A.UserId FROM [User] AS A LEFT OUTER JOIN [UserGuest] AS B ON A.UserId=B.UserId LEFT OUTER JOIN [UserOperator] AS C ON A.UserId=C.UserId WHERE A.IsDeleted=1 AND B.UserId IS NULL AND C.UserId IS NULL);", ct);
