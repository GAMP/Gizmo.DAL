...
namespace Gizmo.DAL.Contexts
{
    ...
    public class DefaultDbContext : DbContext, IGizmoDBContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            ApplyAchievementAndVerificationConfigurations(modelBuilder);
        ...
        /// <summary>
        /// Applies the achievement and verification-method entity configurations.
        /// </summary>
        /// <param name="modelBuilder">Model builder.</param>
        /// <remarks>
        /// The tables backing these types are created by the Update2 migration, so this must stay in step with
        /// it: a type configured here without its table poisons every consumer that walks
        /// <see cref="Microsoft.EntityFrameworkCore.Metadata.IModel"/> instead of the real schema.
        /// </remarks>
        private static void ApplyAchievementAndVerificationConfigurations(ModelBuilder modelBuilder)
        {
