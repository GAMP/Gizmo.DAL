    ...
    public partial class Update1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("SqlServer:Include", new[] { "UserId", "CreatedTime", "Span" });
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "State",
                filter: "[State] <> 2")
                .Annotation("SqlServer:Include", new[] { "UserId", "HostId", "Slot" });
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "IsActive",
                filter: "[IsActive] = 1")
                .Annotation("SqlServer:Include", new[] { "UserId", "NegativeSeconds", "RatesTotal", "CurrentUsageId" });
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("SqlServer:Include", new[] { "OnHand" });
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("SqlServer:Include", new[] { "Amount", "RefundStatus", "RefundedAmount" });

            migrationBuilder.CreateIndex(
                name: "IX_Invoice_CreatedTime_CreatedById_RegisterId",
                table: "Invoice",
                columns: new[] { "CreatedTime", "CreatedById", "RegisterId" })
                .Annotation("SqlServer:Include", new[] { "Total", "Outstanding", "IsVoided", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_Invoice_ReturnFiscalReceiptStatus_Pending",
                table: "Invoice",
                column: "ReturnFiscalReceiptStatus",
                filter: "[ReturnFiscalReceiptStatus] IN (2, 5) AND [IsVoided] = 1 AND [Status] = 2 AND [Total] > 0")
                .Annotation("SqlServer:Include", new[] { "RegisterId" });

            migrationBuilder.CreateIndex(
                name: "IX_Invoice_SaleFiscalReceiptStatus_Pending",
                table: "Invoice",
                column: "SaleFiscalReceiptStatus",
                filter: "[SaleFiscalReceiptStatus] IN (2, 5) AND [IsVoided] = 0 AND [Status] = 2 AND [Total] > 0")
                .Annotation("SqlServer:Include", new[] { "RegisterId" });
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("SqlServer:Include", new[] { "Type", "Amount", "UserId" });
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "CreatedTime")
                .Annotation("SqlServer:Include", new[] { "Amount", "UserId", "CreatedById", "ShiftId", "RegisterId" });

            migrationBuilder.CreateIndex(
                name: "IX_DepositPayment_FiscalReceiptStatus_Pending",
                table: "DepositPayment",
                column: "FiscalReceiptStatus",
                filter: "[FiscalReceiptStatus] IN (2, 5) AND [FiscalReceiptId] IS NULL AND [IsVoided] = 0")
                .Annotation("SqlServer:Include", new[] { "RegisterId" });
            ...
            migrationBuilder.CreateIndex(
                ...
                .Annotation("SqlServer:Include", new[] { "Span" });
